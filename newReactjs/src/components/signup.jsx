    ...
    <div>
      <div className="bgimage min-h-screen  flex justify-center items-center px-4 relative">
        ...
        <form onSubmit={(e) => {
          ...
          <input type="submit" value="Sign up" className="bg-blue-500 font-semibold text-white px-4 py-3 rounded-md hover:bg-blue-900 transition w-full text-sm sm:text-base " />

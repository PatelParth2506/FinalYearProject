...
// import "./PaymentCancel.css"; // Import the custom animation styles
...
const PaymentCancel = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#ffe5e5] via-[#fff8f8] to-[#ffecec] px-4">

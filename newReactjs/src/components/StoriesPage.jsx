         ...
         <div className="flex h-[93vh] flex-col sm:flex-row pb-10 mb-10 sm:mb-0 sm:pb-0">
              ...
              <div className="sm:border-r sm:border-gray-300 flex sm:flex-[2] flex-col sm:px-6 sm:py-6 p-2 lg:flex-1 mt-2 sm:mt-0">
                ...
                <div className="flex flex-row sm:flex-col overflow-hidden">
                  ...
                  <div className="min-w-30 flex items-center justify-between gap-x-3 sm:mb-1 sm:hover:bg-gray-100 p-1 px-2 rounded flex-col sm:flex-row">
                    <div className="w-full flex items-center gap-x-3 flex-col sm:flex-row text-center sm:text-left">
                      <img src={CurrentUser?.profilePhoto} alt="" className="w-[60px] h-[60px] rounded-full border-2 border-[#2B6EA0] p-[2px] flex-shrink-0" />
                  ...
                  {loading ? (
                    ...
                    <div className="overFlow overflow-auto h-full flex items-center sm:items-start flex-row sm:flex-col">
                      ...
                      {storiesData.map((story, index) => (
                        <div key={story._id} className={`min-w-22 sm:min-w-full flex items-center gap-x-3 sm:mb-1 cursor-pointer p-1 px-2 rounded flex-col sm:flex-row text-center sm:text-left transition-all duration-200 ${currentIndex === index ? 'sm:bg-[#e5f3ff] sm:border-l-4 sm:border-[#2B6EA0]' : 'hover:bg-gray-100'}`} onClick={() => setCurrentIndex(index)}>
                          <img src={story.owner?.profilePhoto || dp1} alt="" className="sm:w-[65px] sm:h-[65px] rounded-full border-2 border-[#2B6EA0] p-[2px] flex-shrink-0" />
                          <div className="w-full overflow-hidden">
